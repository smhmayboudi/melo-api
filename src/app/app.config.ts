...
export default registerAs("app", () => ({
  ...
  dataTypeOrmUsername: process.env.APP_DATA_TYPEORM_USERNAME,
  dgraphAddress: process.env.APP_DGRAPH_ADDRESS,
  dgraphDebug: process.env.APP_DGRAPH_DEBUG,
  ...
  siteTypeOrmUsername: process.env.APP_SITE_TYPEORM_USERNAME,
