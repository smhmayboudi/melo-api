...
describe("TagRelationHashIdInterceptor", () => {
  ...
  it("should be defined", () => {
    expect(new TagRelationHashIdInterceptor(service)).toBeDefined();
  });
  ...
  it("intercept should be called undefined", () => {
    ...
    new TagRelationHashIdInterceptor(service)
  ...
  it("intercept should be called with data: tag relation", () => {
    const callHandler: CallHandler = {
      handle: jest.fn(() => of(tagRelation)),
    };
    new TagRelationHashIdInterceptor(service)
      .intercept(executionContext, callHandler)
      .subscribe();
