...
describe("AppConfig", () => {
  it("should be equal to an object", () => {
    expect(config()).toStrictEqual({
      ...
      cacheTTL: undefined,
      dataTypeOrmDatabase: undefined,
      dataTypeOrmHost: undefined,
      dataTypeOrmLogging: undefined,
      dataTypeOrmPassword: undefined,
      dataTypeOrmPort: undefined,
      dataTypeOrmSynchronize: undefined,
      dataTypeOrmUsername: undefined,
      ...
      siteTypeOrmDatabase: undefined,
      siteTypeOrmHost: undefined,
      siteTypeOrmLogging: undefined,
      siteTypeOrmPassword: undefined,
      siteTypeOrmPort: undefined,
      siteTypeOrmSynchronize: undefined,
      siteTypeOrmUsername: undefined,
